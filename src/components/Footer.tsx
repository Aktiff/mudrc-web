        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/70 dark:bg-brand-surface border border-black/10 dark:border-brand-border flex items-center justify-center text-black/70 hover:bg-brand-text hover:text-brand-footer-bg hover:border-brand-text dark:text-brand-muted dark:hover:bg-brand-orange dark:hover:text-brand-btn-fg dark:hover:border-brand-orange transition-colors">
                <FacebookIcon />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/70 dark:bg-brand-surface border border-black/10 dark:border-brand-border flex items-center justify-center text-black/70 hover:bg-brand-text hover:text-brand-footer-bg hover:border-brand-text dark:text-brand-muted dark:hover:bg-brand-orange dark:hover:text-brand-btn-fg dark:hover:border-brand-orange transition-colors">
                <InstagramIcon />
              </a>
            </div>
          </div>
